...
public class EsJsonMapper {
    //JsonMapper 工具
    private ObjectMapper mapper;
    private static EsJsonMapper jsonMapper;
    private static EsJsonMapper jsonNonDefaultMapper;
    private static EsJsonMapper jsonNonDefaultMapperRoot;
    private static EsJsonMapper josnNonEmptyMapperRoot;

    public EsJsonMapper() {
        this((JsonInclude.Include) null, false);
    }

    public EsJsonMapper(JsonInclude.Include include, boolean root) {
    ...
    public static EsJsonMapper nonEmptyMapper() {
        if (jsonMapper == null) {
            jsonMapper = new EsJsonMapper(JsonInclude.Include.NON_EMPTY, false);
        }

        return jsonMapper;
    }

    public static EsJsonMapper nonEmptyMapperRoot() {
        if (josnNonEmptyMapperRoot == null) {
            josnNonEmptyMapperRoot = new EsJsonMapper(JsonInclude.Include.NON_EMPTY, true);
        }

        return josnNonEmptyMapperRoot;
    }

    public static EsJsonMapper nonDefaultMapper() {
        if (jsonNonDefaultMapper == null) {
            jsonNonDefaultMapper = new EsJsonMapper(JsonInclude.Include.NON_DEFAULT, false);
        }

        return jsonNonDefaultMapper;
    }

    public static EsJsonMapper nonDefaultMapperRoot() {
        if (jsonNonDefaultMapperRoot == null) {
            jsonNonDefaultMapperRoot = new EsJsonMapper(JsonInclude.Include.NON_DEFAULT, true);
        }
