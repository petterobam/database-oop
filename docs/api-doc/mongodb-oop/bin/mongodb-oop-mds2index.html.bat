...
:: remove mongodb-oop/bin/
set jar_base_path=%curr_path:~0,-16%
:: jar File Path
...
echo "#############################################################"
echo "run java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> mongodb-oop-mds2index.html.log 2>> mongodb-oop-mds2index.html-error.log"
java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> ..\log\mongodb-oop-mds2index.html.log 2>> ..\log\mongodb-oop-mds2index.html-error.log
echo "#############################################################"
echo ">>>>>>>>>>>convert over!!"
echo "------------------------------------------------------------"
Pause
