...
:: remove sqlserver-oop/bin/
set jar_base_path=%curr_path:~0,-18%
:: jar File Path
...
echo "#############################################################"
echo "run java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> sqlserver-oop-mds2index.html.log 2>> sqlserver-oop-mds2index.html-error.log"
java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> ..\log\sqlserver-oop-mds2index.html.log 2>> ..\log\sqlserver-oop-mds2index.html-error.log
echo "#############################################################"
echo ">>>>>>>>>>>convert over!!"
echo "------------------------------------------------------------"
Pause
