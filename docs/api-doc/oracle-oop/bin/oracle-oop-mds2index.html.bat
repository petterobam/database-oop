...
:: remove oracle-oop/bin/
set jar_base_path=%curr_path:~0,-15%
:: jar File Path
...
echo "#############################################################"
echo "run java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> oracle-oop-mds2index.html.log 2>> oracle-oop-mds2index.html-error.log"
java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> ..\log\oracle-oop-mds2index.html.log 2>> ..\log\oracle-oop-mds2index.html-error.log
echo "#############################################################"
echo ">>>>>>>>>>>convert over!!"
echo "------------------------------------------------------------"
Pause
