...
public class AccessUtils {
    ...
    public static String getClassRootPath(String path) {
        path = AccessUtils.trimToEmpty(path);
        String filePath = AccessUtils.class.getResource("/").getPath().toString();
    ...
    public static Object readField(final Field field, final Object target, final boolean forceAccess) throws IllegalAccessException {
        ...
        if (forceAccess && !field.isAccessible()) {
            ...
            AccessUtils.setAccessibleWorkaround(field);
        }
    ...
    public static String getJson(Object object) {
        try {
            return AccessJsonUtils.toJSONString(object);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String getJson(List list) {
        if (list == null) return "[]";
        return AccessJsonUtils.toJSONString(list);
    }
    ...
    public static <T> T getInstance(String jsonString, Class clazz) {
        if (AccessUtils.isBlank(jsonString)) return null;
        if ("[]".equals(AccessUtils.trim(jsonString))) return null;
