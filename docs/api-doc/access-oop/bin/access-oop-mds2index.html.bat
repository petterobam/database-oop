...
echo "#############################################################"
echo "run java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> access-oop-mds2index.html.log 2>> access-oop-mds2index.html-error.log"
java -jar %jar_path% %conf_path% %mds_path% %tpl_path% %out_path% >> ..\log\access-oop-mds2index.html.log 2>> ..\log\access-oop-mds2index.html-error.log
echo "#############################################################"
echo ">>>>>>>>>>>convert over!!"
echo "------------------------------------------------------------"
Pause
